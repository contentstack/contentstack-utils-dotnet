...
namespace Contentstack.Utils.Tests
{
    public class GQLTest
    {
        ...
        public void Should_Return_Result_For_AssetReference_With_Embedded_Items()
        {
            ...
            Assert.Equal(new List<string>() { "<img src=\"/v3/assetsUID_12/dummy.pdf\" alt=\"dummy.pdf\" />" }, multipleRTE);
            Assert.Equal("<img src=\"/v3/assetsUID_12/dummy.pdf\" alt=\"dummy.pdf\" />", singleRTE);
        }
        ...
        public void Should_Return_Result_For_Reference_Entry_As_Block()
        {
            ...
            Assert.Equal(new List<string>() { "<div><p>UID_07</p><p>Content type: <span>content_block</span></p></div>" }, multipleRTE);
            Assert.Equal("<div><p>UID_07</p><p>Content type: <span>content_block</span></p></div>", singleRTE);
        }
        ...
        public void Should_Return_Result_For_Reference_Entry_As_Link()
        {
            ...
            Assert.Equal(new List<string>() { "<a href=\"UID_08\">/copy-of-entry-final-02</a>" }, multipleRTE);
            Assert.Equal("<a href=\"UID_08\">/copy-of-entry-final-02</a>", singleRTE);
        }
        ...
        public void Should_Return_Result_For_Reference_Entry_As_Inline()
        {
            ...
            Assert.Equal(new List<string>() { "<span>UID_09</span>" }, multipleRTE);
            Assert.Equal("<span>UID_09</span>", singleRTE);
        }
