...
namespace Contentstack.Utils.Tests
{
    public class UtilsArrayStringTest
    {
        ...
        {
            List<string> result = Utils.RenderContent(new List<string>() { Constants.Constants.kEntryBlock }, new DefaultRenderMock(new EmbeddedModel("", embedContentUID: "blt55f6d8cbd7e03a1f")));
            Assert.Equal("<div><p>blt55f6d8cbd7e03a1f</p><p>Content type: <span>contentTypeUid</span></p></div>", result[0]);
        }

        [Fact]
        public void testEntryInline()
        {
            List<string> result = Utils.RenderContent(new List<string>() { Constants.Constants.kEntryInline }, new DefaultRenderMock(new EmbeddedModel("", embedContentUID: "blt55f6d8cbd7e03a1f")));
        ...
        {
            List<string> result = Utils.RenderContent(new List<string>() { Constants.Constants.kEntryLink }, new DefaultRenderMock(new EmbeddedModel("", embedContentUID: "blt55f6d8cbd7e03a1f")));
        ...
        public void testEntryBlockLink()
        {
            ...
            result = Utils.RenderContent(new List<string>() { $"{Constants.Constants.kEntryBlock}{Constants.Constants.kEntryLink}" }, new DefaultRenderMock(new EmbeddedModel("", embedContentUID: "blt55f6d8cbd7e03a1f")));
            Assert.Equal("<div><p>blt55f6d8cbd7e03a1f</p><p>Content type: <span>contentTypeUid</span></p></div><a href=\"blt55f6d8cbd7e03a1f\">{{title}}</a>", result[0]);
        }
        ...
        public void testEntryBlockLinkInline()
        {
            ...
            result = Utils.RenderContent(new List<string>() { $"{Constants.Constants.kEntryBlock}{Constants.Constants.kEntryLink}  {Constants.Constants.kEntryInline}" }, new DefaultRenderMock(new EmbeddedModel("", embedContentUID: "blt55f6d8cbd7e03a1f")));
            Assert.Equal("<div><p>blt55f6d8cbd7e03a1f</p><p>Content type: <span>contentTypeUid</span></p></div><a href=\"blt55f6d8cbd7e03a1f\">{{title}}</a>  <span>blt55f6d8cbd7e03a1f</span>", result[0]);
        }
        ...
        public void testAllEmbedStyles()
        {
            ...
            result = Utils.RenderContent(new List<string>() { $"{Constants.Constants.kAssetDisplay}{Constants.Constants.kEntryBlock}{Constants.Constants.kEntryLink} {Constants.Constants.kEntryInline}" }, new DefaultRenderMock(new EmbeddedModel("", embedContentUID: "blt55f6d8cbd7e03a1f")));
            Assert.Equal("<div><p>blt55f6d8cbd7e03a1f</p><p>Content type: <span>contentTypeUid</span></p></div><a href=\"blt55f6d8cbd7e03a1f\">{{title}}</a> <span>blt55f6d8cbd7e03a1f</span>", result[0]);
        }
        ...
        public void testAllEmbedStylesWithAllEmbedObject()
        {
            ...
            result = Utils.RenderContent(new List<string>() { $"{Constants.Constants.kAssetDisplay}{Constants.Constants.kEntryBlock}{Constants.Constants.kEntryLink} {Constants.Constants.kEntryInline}" }, new DefaultRenderMock(new EmbeddedModel("", embedContentUID: "blt55f6d8cbd7e03a1f", embedAssetUID: "blt55f6d8cbd7e03a1f")));
            Assert.Equal("<img src=\"url\" alt=\"title\" /><div><p>blt55f6d8cbd7e03a1f</p><p>Content type: <span>contentTypeUid</span></p></div><a href=\"blt55f6d8cbd7e03a1f\">{{title}}</a> <span>blt55f6d8cbd7e03a1f</span>", result[0]);
        }
    }
}
